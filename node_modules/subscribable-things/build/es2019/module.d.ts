...
export declare const attribute: (htmlElement: HTMLElement, name: string) => import("./types/subscribable-thing").TSubscribableThing<null | string>;
export declare const geolocation: (options?: PositionOptions) => import("./types/subscribable-thing").TSubscribableThing<GeolocationPosition>;
