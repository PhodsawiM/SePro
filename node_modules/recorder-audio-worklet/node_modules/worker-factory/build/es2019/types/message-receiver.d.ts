...
export type TMessageReceiver<T extends TMessage> = T['params'] extends undefined ? TMessageReceiverWithoutParams<T['response']> : TMessageReceiverWithParams<T['params'], T['response']>;
